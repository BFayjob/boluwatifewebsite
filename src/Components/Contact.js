...
const Contact = () => {
  return (
    <article className="bg-gradient-to-b from-warm-light to-warm-dark text-gray-800 py-12 flex flex-col items-center rounded-t-[50%]">
    ...
    Are you ready to see what I can do?
      ...
      <div className="flex items-center mb-6">
        ...
        <article className="w-1/2 pr-4">
          ...
          <img className="self-center w-3/4 mx-auto mb-4 md:mb-0 md:mx-0 md:w-full css-keakeu e1nqwh8g0" src="IMG_4590.jpg" alt="Your" />
        </article>
